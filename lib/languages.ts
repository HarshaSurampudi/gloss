...
/** Full list of languages Gemini can explain in. Ordered alphabetically
 *  by English name except English which leads. */
...
/**
 * Pinned to the `latest` aliases — these auto-track Google's current stable
